  ...
  return (
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <button className="profile"><span>TS</span><div><strong>Tanner Schulz</strong><small>Loan officer</small></div><i>•••</i></button>
      </aside>
      ...
      <section className="workspace">
        ...
        {view === "Overview" && <Overview onViewAll={() => setView("Borrowers")} onSelect={setSelected} onCopy={copyLink} />}
...
function Overview({ onViewAll, onSelect, onCopy }: { onViewAll: () => void; onSelect: (borrower: Borrower) => void; onCopy: (slug?: string) => void }) {
  return <div className="page-content">
    <div className="page-heading"><div><p>MONDAY, AUGUST 10</p><h1>Good morning, Tanner.</h1><span>Here is what is happening across your borrower pipeline.</span></div><button className="secondary-button" onClick={() => onCopy()}>↗ Share your link</button></div>
